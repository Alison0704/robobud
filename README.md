# RoboBud - The Pet Assistant Project

Build a Web App where a robotic pet prompts the user to feed or play based on its status levels, which also determine whether it complies with a given task.
